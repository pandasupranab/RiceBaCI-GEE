...
MANU_FIGS = [
    ...
    ("Figure 6",
     ...
     "Figure 6. In-space placebo distribution from donor-swap permutation (56 reassignments of treatment status to inland-control districts). Real τ̂ marked by red dashed line. Corrected/EOS cell hits the design-floor p_perm = 0.018 at G = 8."),
